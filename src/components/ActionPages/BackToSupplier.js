...
function BackToSupplier() {
   ...
   const backToSupplierProblemList = problems.filter(item => item.action === 'Возврат поставщику');
            ...
            <div className='problem__block'>
               <ul className='problem__list'>
                  <li className='problem__item'>
                     {backToSupplierProblemList.sort((a, b) => parseInt(b.defect_qty) - parseInt(a.defect_qty)).slice(0, 3).map((problem, index) => (
