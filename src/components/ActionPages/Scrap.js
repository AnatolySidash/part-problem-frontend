...
function Scrap() {
   ...
   const scrapProblemList = problems.filter(item => item.action === 'Утилизация');
            ...
            <div className='problem__block'>
               <ul className='problem__list'>
                  <li className='problem__item'>
                     {scrapProblemList.sort((a, b) => parseInt(b.defect_qty) - parseInt(a.defect_qty)).slice(0, 3).map((problem, index) => (
