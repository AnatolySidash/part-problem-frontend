...
function BackToLine() {
   ...
   const backToLineProblemList = problems.filter(item => item.action === 'Возврат на линию');
            ...
            <div className='problem__block'>
               <ul className='problem__list'>
                  <li className='problem__item'>
                     {backToLineProblemList.sort((a, b) => parseInt(b.defect_qty) - parseInt(a.defect_qty)).slice(0, 3).map((problem, index) => (
