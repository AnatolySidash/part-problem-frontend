...
function Other() {
   ...
   const otherProblemList = problems.filter(item => item.action === 'Другое');
            ...
            <div className='problem__block'>
               <ul className='problem__list'>
                  <li className='problem__item'>
                     {otherProblemList.sort((a, b) => parseInt(b.defect_qty) - parseInt(a.defect_qty)).slice(0, 3).map((problem, index) => (
