...
function ChassisSystem() {

   const problems = useOutletContext();

   const chassisProblemList = problems.filter(item => item.system === 'Шасси');
            ...
            <div className='problem__block'>
               <ul className='problem__list'>
                  <li className='problem__item'>
                     {chassisProblemList.sort((a, b) => parseInt(b.defect_qty) - parseInt(a.defect_qty)).slice(0, 3).map((problem, index) => (
