...
function ElectricSystem() {

   const problems = useOutletContext();

   const electricProblemList = problems.filter(item => item.system === 'Электрика');
            ...
            <div className='problem__block'>
               <ul className='problem__list'>
                  <li className='problem__item'>
                     {electricProblemList.sort((a, b) => parseInt(b.defect_qty) - parseInt(a.defect_qty)).slice(0, 3).map((problem, index) => (
