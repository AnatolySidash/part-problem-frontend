...
function MovingSystem() {
   ...
   const movingProblemList = problems.filter(item => item.system === 'Мувинг');
            ...
            <div className='problem__block'>
               <ul className='problem__list'>
                  <li className='problem__item'>
                     {movingProblemList.sort((a, b) => parseInt(b.defect_qty) - parseInt(a.defect_qty)).slice(0, 3).map((problem, index) => (
